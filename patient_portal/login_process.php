...
$login_id = cleanInput(trim($_POST['login_id'] ?? ''));
$password = $_POST['password'] ?? '';

if ($login_id === "" || $password === "")
{
    $_SESSION['error'] = "Please enter Email/Mobile and Password.";
    redirect("login.php");
}
...
{
    $_SESSION['error'] = "Please enter a valid Email or Mobile Number.";
    redirect("login.php");
}
...
if (
    ...
    &&
    strtotime($patient['account_locked_until']) > time()
)
{
    $_SESSION['error'] =
